...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'select-slot',
        loadChildren: () =>
          import('./select-slot/select-slot.module').then(
            (m) => m.SelectSlotPageModule
          ),
        canActivate: [AuthGuard],
      },
      {
        ...
        loadChildren: () =>
          import('./select-payment-method/select-payment-method.module').then(
            (m) => m.SelectPaymentMethodPageModule
          ),
        canActivate: [AuthGuard],
      },
      {
      ...
      },
      {
        path: 'refer-afriend',
        loadChildren: () =>
          import('./refer-afriend/refer-afriend.module').then(
            (m) => m.ReferAfriendPageModule
          ),
        canActivate: [AuthGuard],
      },
      {
        ...
        loadChildren: () =>
          import('./Notification/no-notification/no-notification.module').then(
            (m) => m.NoNotificationPageModule
          ),
        canActivate: [AuthGuard],
      },
      {
        path: 'notification',
        loadChildren: () =>
          import('./Notification/notification/notification.module').then(
      ...
      },
      {
        path: 'reschedule',
        loadChildren: () =>
          import('./reschedule/reschedule.module').then(
            (m) => m.ReschedulePageModule
          ),
        canActivate: [AuthGuard],
      },

      {
        ...
        loadChildren: () =>
          import('./booking/booking-details/booking-details.module').then(
  ...
  },
  {
    path: 'plan-a-party',
    loadChildren: () =>
      import('./plan-a-party/plan-a-party.module').then(
        (m) => m.PlanAPartyPageModule
      ),
  },
  {
    path: 'sample',
